...
var m_start_bytes = Buffer.from([27, 33, 16]);//Buffer.from([27, 33, 16, 28, 33, 8]);
var m_end_bytes = Buffer.from([27, 33, 0]);//Buffer.from([27, 33, 0, 28, 33, 0]);
...
var cd_start_bytes = Buffer.from([27, 97, 1, 27, 33, 32]);//Buffer.from([27, 97, 1, 27, 33, 32, 28, 33, 4]);
var cd_end_bytes = Buffer.from([27, 33, 0, 28, 33, 0]);//Buffer.from([27, 33, 0, 28, 33, 0]);
